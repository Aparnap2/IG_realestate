"""
Direct test script for industry configuration system.
This script tests industry configs by importing the module directly.
"""
...
# Import the module directly to avoid config package dependencies
import importlib.util
spec = importlib.util.spec_from_file_location(
    "industry_configs",
    "config/industry_configs.py"
)
industry_configs = importlib.util.module_from_spec(spec)
spec.loader.exec_module(industry_configs)

# Get classes from the module
IndustryConfigManager = industry_configs.IndustryConfigManager
IndustryConfig = industry_configs.IndustryConfig
IndustryType = industry_configs.IndustryType
...
def run_all_tests():
    """Run all tests."""
    print("Industry Configuration System - Direct Tests")
    print("=" * 50)
    print()
