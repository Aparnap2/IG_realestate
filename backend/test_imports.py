...
def test_lead_model():
    ...
    try:
        # Mock the OpenAI and Supabase clients before importing our modules
...
def test_imports():
    ...
    try:
        ...
        with patch('openai.OpenAI'), patch('supabase.create_client'), patch('redis.from_url', return_value=mock_redis_client):
            ...
            from backend.agents import qualifier, scheduler, followup
            from backend.tools import handoffs
